...
import { addItem, deleteItem, editItem, findSingleItem, getItemByCity, getItemsByShop, itemRating, searchItems } from "../controllers/item.controller.js";
...
router.post("/rating", isAuth, itemRating )
